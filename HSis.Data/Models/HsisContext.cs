...
public partial class HsisContext : DbContext
{
    public HsisContext()
    {
    }

    public HsisContext(DbContextOptions<HsisContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IngresosMaterial>(entity =>
        {
            ...
            entity.Property(e => e.FechaIngreso)
                .HasDefaultValueSql("(getdate())", "DF_Ingreso_Fecha")
                .HasColumnType("datetime")
        ...
        modelBuilder.Entity<Material>(entity =>
        {
            ...
            entity.Property(e => e.UnidadMedida)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasDefaultValue("Pieza", "DF_Material_Unidad")
        ...
        modelBuilder.Entity<VHistorialInventario>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("v_Historial_Inventario");
            ...
            entity.Property(e => e.ValorTotalMovimiento)
                .HasColumnType("smallmoney")
                .HasColumnName("Valor_Total_Movimiento");
        });
